...
IMAGES_PATH = os.environ["PARSE_RESULTS_PATH"]
CHROMA_DB_PATH = os.environ["CHROMA_STORAGE_PATH"]
VISION_LLM_URL = os.environ["VISION_LLM_URL"]
SUMMARY_LLM_URL = os.environ["SUMMARY_LLM_URL"]
PAPERS_PATH = os.environ["PAPERS_STORAGE_PATH"]
        ...
        try:
            os.system(
                " ".join(
                    [
                        "sh",
                        os.path.join(ROOT_DIR, "marker_parsing.sh"),
                        str(path_to_docs),
                        str(out_path),
                        str(self.workers)
                    ]
