...
extract_query_filters_prompt = (
    ...
    "\nIf the question refers to multiple domains, return all matching domains as a list."
    "\nResearch sub-domain must belong to the selected research domain according to this mapping:"
    ...
    "\nIf the question refers to multiple sub-domains, return all matching sub-domains as a list."
    "\nAlways try to identify and return at least 4 different sub-domains that could potentially relate to the question."
    "\nIf you cannot find 4 sub-domains, return all that are relevant, even if fewer than 4."
